define(['exports', 'module', 'libs/backbone', './Basket'], function (exports, module, _libsBackbone, _Basket) {
    'use strict';
    ...
    var _BasketModel = _interopRequireDefault(_Basket);

    var BasketCollection = (function (_Backbone$Collection) {
        ...
        _inherits(BasketCollection, _Backbone$Collection);

        _createClass(BasketCollection, [{
            key: 'initialize',
            value: function initialize() {
                this.model = _BasketModel['default'];
            }
        }, {
            key: 'url',
