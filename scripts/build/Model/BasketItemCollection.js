define(['exports', 'module', 'libs/backbone', './BasketItem'], function (exports, module, _libsBackbone, _BasketItem) {
    'use strict';
    ...
    var _BasketItemModel = _interopRequireDefault(_BasketItem);

    var BasketItemCollection = (function (_Backbone$Collection) {
        ...
        _inherits(BasketItemCollection, _Backbone$Collection);
        ...
        _createClass(BasketItemCollection, [{
            ...
            value: function initialize(models, options) {
                this.model = _BasketItemModel['default'];
            }
        }]);
